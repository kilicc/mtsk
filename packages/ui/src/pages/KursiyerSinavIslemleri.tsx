...
export default function KursiyerSinavIslemleri() {
  ...
  const loadSinavTarihleri = async () => {
    try {
      // Mock sınav tarihleri - gerçek uygulamada API'den gelecek
      const mockTarihler = [
        '2024-11-20',
        '2024-11-25',
        '2024-12-01',
  ...
  return (
    <div className="p-4 space-y-6" style={{ height: '100%', overflowY: 'auto' }}>
      ...
      <div className="card">
        <h3 className="text-lg font-bold text-gray-900 mb-2">Kursiyer Ekle</h3>
        <p className="text-sm text-gray-600 mb-4">
          Seçtiğiniz sınav tarihlerine toplu veya tekil olarak kursiyer ekleyebilirsiniz.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="sinav-kaynak">Kaynak</label>
            <select
              id="sinav-kaynak"
              value={kaynak}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="sinav-turu">Sınav Türü</label>
            <select
              id="sinav-turu"
              value={sinavTuru}
              onChange={(e) => {
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="sinav-tarihi">Sınav Tarihi</label>
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          <button onClick={handleTamEkran} className="btn btn-outline text-sm">
            Tam Ekran
          </button>
        </div>
      </div>
      ...
      <div className="card bg-amber-50 border border-amber-200">
        <p className="text-sm text-amber-800">
          <strong>Dikkat:</strong> Girmiş olduğunuz sınav notları ve sınav durumları anlık olarak sisteme girilmektedir. 
          Sınav not girişi için notu girdikten sonra <strong>TAB tuşuna basmanız</strong> veya{' '}
          <strong>not girilen alanın dışında</strong> bir yere tıklamanız yeterli olacaktır. 
          Eğer bunu iptal etmek istiyorsanız sağ üstte bulunan <strong>Otomatik Kaydet</strong> tikini kaldırmanız yeterli olacaktır.
        </p>
      </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="otomatik-kaydet" className="text-sm text-gray-700">
              Otomatik Kaydet
            </label>
          </div>
        </div>
